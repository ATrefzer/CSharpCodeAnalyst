...
/// <summary>
///     Polymorphism and virtual method dispatch: a base class with virtual/non-virtual members, several
///     overriding subclasses, and a separate abstract Vehicle hierarchy. Migrated from the former
///     Core.ObjectOriented approval fixture (Polymorphism.cs).
/// </summary>
[TestFixture]
public class ObjectOriented_PolymorphismParseTests : InMemoryParseTestBase
{
    ...
    public void Classes_AreDetected()
    {
        var expected = new[]
        {
            "Animal", "Dog", "Cat", "Bird", "AnimalShelter", "Vehicle", "Car", "Motorcycle"
        };
